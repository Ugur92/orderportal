...
{
    public partial class Stoktanim1
    {
        ...
        public decimal? Kiciadet { get; set; }
        public string Kolitipi { get; set; }
        public string Ambalajnitelik { get; set; }
        public string Etiketnitelik { get; set; }
        public string Ambalajnitelik2 { get; set; }
        public decimal? Tabakagirlik { get; set; }
        public decimal? Posetagirlik { get; set; }
        public decimal? Klipsagirlik { get; set; }
        public decimal? Strecagirlik { get; set; }
        public decimal? Strecuzunluk { get; set; }
        public decimal? Etiketagirlik { get; set; }
        public decimal? Kaplama { get; set; }
        public decimal? Dokmenaylon { get; set; }
        public decimal? Kiciparcaadet { get; set; }
        public decimal? Stickeragirlik { get; set; }
        public decimal? Kolibasiurtmaliyet { get; set; }
        public decimal? Kgbasiurtmaliyet { get; set; }
        public decimal? Opcarpan { get; set; }
        public decimal? Opbolen { get; set; }
        public string Ozelkod10 { get; set; }
        public string Ozelkod11 { get; set; }
        public string Ozelkod12 { get; set; }
        public string Ozelkod13 { get; set; }
        public string Ozelkod14 { get; set; }
        public string Ozelkod15 { get; set; }
        public decimal? Esik6 { get; set; }
        public decimal? Esik12 { get; set; }
        public decimal? Listesirano { get; set; }
        public string Optimizasyongrubu { get; set; }
        public string Opparam1 { get; set; }
        public decimal? Ortalamakolikg { get; set; }
        public decimal? Urunoran { get; set; }
        public string Usturun { get; set; }
        public string Usturunoran { get; set; }
        public string Opparam2 { get; set; }
        public decimal? Ortalamapargr { get; set; }
        public decimal? Karkasmiktarkg { get; set; }
        public bool? Siparislistevar { get; set; }
        public string Randimangrup { get; set; }
        public string Randimangrup2 { get; set; }
        public string Randimangrup3 { get; set; }
        public string Uretimhatti { get; set; }
        public string Ozelkod16 { get; set; }
        public string Ozelkod17 { get; set; }
